        ...
        <section className="py-20 px-10 max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            ...
            <div className="mt-8 flex gap-4">
              <a href="#Proyectos" className="relative overflow-hidden bg-blue-500/20 backdrop-blur-xl border border-blue-400/30 text-blue-200 px-8 py-3 rounded-xl font-bold transition-all duration-500 hover:bg-blue-400/30 hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:text-white active:scale-95">
